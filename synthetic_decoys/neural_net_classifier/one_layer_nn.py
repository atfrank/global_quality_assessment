...
def main():
  ...
  # grid search cv 
  param_grid = dict(opt = opt, epochs = epochs, init = init, loss = loss, neurons = neurons, 
                    batch_size = batch_size, lr = lr, l2 = l2, activation = activation)
  ...
  train_result.to_csv(DIR_PATH + 'train_predictions.txt', sep = ' ', index = False)
  test_result.to_csv(DIR_PATH + 'test_predictions.txt', sep = ' ', index = False)
  # save model
  best_model = clf.best_estimator_
  modelname = DIR_PATH + 'nn_classifier.h5'
