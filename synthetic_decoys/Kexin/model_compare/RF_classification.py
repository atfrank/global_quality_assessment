...
def main():
  ...
  # IMPLEMENT MODEL
  rf = RandomForestClassifier(oob_score = True, verbose = 2)
  ...
  rf_cv = GridSearchCV(rf, grid, cv = 5, verbose = 2, scoring = 'accuracy')
  grid_result = rf_cv.fit(X_train, y_train)

  logfile = DIR_PATH+'model_compare/log/rfclf'+rna+'_'+str(m)+'.txt'
