...
def main():
  ...
  # grid search cv 
  rf = ExtraTreesClassifier(oob_score = True, verbose = 1)
  ...
  logfile = DIR_PATH+'log/ert_log_'+rna+'.txt'
  ...
  train_result.to_csv(DIR_PATH + 'pred/ert_train_pred_'+rna+'.txt', sep = ' ', index = False)
  test_result.to_csv(DIR_PATH + 'pred/ert_test_pred_'+rna+'.txt', sep = ' ', index = False)
  
  # save best model
  best_model = clf.best_estimator_
  modelname = DIR_PATH + 'models/ert_model_'+rna+'.sav'
