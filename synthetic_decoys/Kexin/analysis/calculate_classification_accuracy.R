load_model_accuracy <- function(file = "data/section_1/NN_accuracy_0.6.txt", colnames = c("id", "sen", "spec", "overall"), header = FALSE){
...
acc_NN = load_model_accuracy("Kexin_NN/nn_loo_acc_3.0.txt")
...
acc_ert = load_model_accuracy("Kexin_RF/ert_loo_acc_3.0.txt")
